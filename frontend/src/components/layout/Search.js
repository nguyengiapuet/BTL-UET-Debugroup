...
function Search({ isFocused, setIsFocused }) {
	...
	return (
		<div
			className={`w-full border-2 rounded-3xl relative flex items-center px-4 transition-colors duration-300 ${
		...
		>
			...
			{showResult && searchResult.length > 0 && (
				<div className="z-[999] search-container flex flex-col bg-slate-200 shadow-md rounded-xl absolute top-12 left-0 w-full items-start p-2 max-h-[250px] overflow-y-scroll">
