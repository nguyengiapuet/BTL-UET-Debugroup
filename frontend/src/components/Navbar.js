    ...
    return (  
        <div className="coding-box bg-[#ffffff] w-[320px] min-h-screen flex flex-col items-center gap-8 px-6">
            <div className=" w-full h-28 flex items-center justify-center">
                <p className='text-[#9C6317] text-4xl shadow-xl font-semibold'>
                    Debugroup
                </p>
            </div>
            ...
            <div className='w-full border-[#D9D9D9] border-2 rounded-full flex items-center px-4'>
                ...
                <input type='text' placeholder='Enter your text' className='w-full rounded-full font-normal py-2 px-2 outline-none'/>
            </div>
            ...
            <div className=' h-full w-full flex flex-col gap-2'>
                <button value={"home"} className='flex gap-4 items-center rounded-md px-2 py-1 hover:bg-slate-200' onClick={handleClickActive}>
                    <FaHome className={ `${active==='home' ? 'text-[#9c6317] text-3xl' : 'text-[#7a7a7a] text-3xl'}` }/>
                    <Link to={'/'} onClick={() => setTitle("Home")} className={ `${active==='home' ? 'text-[#9c6317]' : 'text-[#7a7a7a] font-normal'}` } >
                        <button value={'home'}>
                            Home
                        </button>
                    </Link>
                </button>
                <button value={'dashboard'} className='flex gap-4 items-center rounded-md px-2 py-1 hover:bg-slate-200' onClick={handleClickActive}>
                    <FaClipboardList className={ `${active==='dashboard' ? 'text-[#9c6317] text-3xl' : 'text-[#7a7a7a] text-3xl'}` }/>
                    <Link to={'/dashboard'} onClick={() => setTitle("Dashboard")} className={ `${active==='dashboard' ? 'text-[#9c6317]' : 'text-[#7a7a7a] font-normal'}` } >
