        ...
        <div className="w-[calc(100wh-20px)] max-h-[calc(100vh-64px)] min-h-[calc(100vh-64px)] flex flex-col">
            <div className="h-[64px] bg-[#1D1C1C] flex items-center justify-between">
                ...
                <div className="flex gap-2 px-2">
                    <Link to={'/'} onClick={handleSavePens} className="flex gap-1 items-center bg-[#9C6317] px-4 py-2 rounded text-white hover:bg-opacity-75">
                        <FaShare />
                        <button>Share</button>
                    </Link>
                    <Link to={'/'} onClick={handleSavePens} className="flex gap-1 items-center bg-[#9C6317] px-4 py-2 rounded text-white hover:bg-opacity-75">
                    ...
                    {userData.id ? (
                        <div className="flex gap-2 items-center">
                            ...
                            {
                            userData.avatar ? (
                                <img alt="" src={userData.avatar} className="w-12 h-12 rounded-full border border-gray-400"/>
                            ) : (
